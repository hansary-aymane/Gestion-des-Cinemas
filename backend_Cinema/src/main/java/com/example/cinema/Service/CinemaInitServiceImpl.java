...
public class CinemaInitServiceImpl implements ICinemaInitService {
    ...
    public void initVille() {
        Stream.of("Casablanca","Rabat","Marrakech").forEach(name->{
    ...
    villeRepository.findAll().forEach(ville->{
        Stream.of("IMAX","Megarama","RIF","L'ARC").forEach(name->{
    ...
    public void initSeances() {
        ...
        Stream.of("11:00","15:00","17:00","20:00").forEach(s->{
    ...
    public void initFilm() {
        ...
        Stream.of("Game of Thrones","IRON Man","Seigneur des anneaux","SpiderMan").forEach(film->{
            Film film1 = new Film();
            film1.setTitre(film);
